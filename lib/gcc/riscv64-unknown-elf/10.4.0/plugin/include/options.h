...
enum opt_code
{
  ...
  OPT_mriscv_fli_value_by_int = 1649,        /* -mriscv_fli_value_by_int */
  OPT_mrnreg_delete_noop_move = 1650,        /* -mrnreg-delete-noop-move */
  OPT_mrvv_vector_bits_ = 1651,              /* -mrvv-vector-bits= */
  OPT_msave_restore = 1652,                  /* -msave-restore */
  OPT_mshorten_memrefs = 1653,               /* -mshorten-memrefs */
  OPT_msignedness_cmpiv = 1654,              /* -msignedness-cmpiv */
  OPT_msmall_data_limit_ = 1655,             /* -msmall-data-limit= */
  OPT_msrri = 1656,                          /* -msrri */
  OPT_msrriw = 1657,                         /* -msrriw */
  OPT_mstrict_align = 1658,                  /* -mstrict-align */
  OPT_mthread_jumps1 = 1659,                 /* -mthread-jumps1 */
  OPT_mtune_ = 1660,                         /* -mtune= */
  OPT_munaligned_libcall = 1661,             /* -munaligned-libcall */
  OPT_mxor_combine = 1662,                   /* -mxor-combine */
  OPT_n = 1663,                              /* -n */
  OPT_name_sort = 1664,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1665,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1666,              /* -no-integrated-cpp */
  OPT_no_pie = 1667,                         /* -no-pie */
  OPT_nocpp = 1668,                          /* -nocpp */
  OPT_nodefaultlibs = 1669,                  /* -nodefaultlibs */
  OPT_nolibc = 1670,                         /* -nolibc */
  OPT_nophoboslib = 1671,                    /* -nophoboslib */
  OPT_nostartfiles = 1672,                   /* -nostartfiles */
  OPT_nostdinc = 1673,                       /* -nostdinc */
  OPT_nostdinc__ = 1674,                     /* -nostdinc++ */
  OPT_nostdlib = 1675,                       /* -nostdlib */
  OPT_o = 1676,                              /* -o */
  OPT_objects = 1677,                        /* -objects */
  OPT_p = 1678,                              /* -p */
  OPT_pass_exit_codes = 1679,                /* -pass-exit-codes */
  /* OPT_pedantic = 1680, */                 /* -pedantic */
  OPT_pedantic_errors = 1681,                /* -pedantic-errors */
  OPT_pg = 1682,                             /* -pg */
  OPT_pie = 1683,                            /* -pie */
  OPT_pipe = 1684,                           /* -pipe */
  ...
  OPT_r = 1699,                              /* -r */
  OPT_remap = 1700,                          /* -remap */
  OPT_reverse_sort = 1701,                   /* -reverse-sort */
  OPT_s = 1702,                              /* -s */
  OPT_save_temps = 1703,                     /* -save-temps */
  OPT_save_temps_ = 1704,                    /* -save-temps= */
  OPT_shared = 1705,                         /* -shared */
  OPT_shared_libgcc = 1706,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1707,               /* -shared-libphobos */
  OPT_size_sort = 1708,                      /* -size-sort */
  /* OPT_specs = 1709, */                    /* -specs */
  OPT_specs_ = 1710,                         /* -specs= */
  OPT_static = 1711,                         /* -static */
  OPT_static_libasan = 1712,                 /* -static-libasan */
  OPT_static_libgcc = 1713,                  /* -static-libgcc */
  OPT_static_libgfortran = 1714,             /* -static-libgfortran */
  OPT_static_libgo = 1715,                   /* -static-libgo */
  OPT_static_liblsan = 1716,                 /* -static-liblsan */
  OPT_static_libmpx = 1717,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1718,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1719,               /* -static-libphobos */
  OPT_static_libstdc__ = 1720,               /* -static-libstdc++ */
  OPT_static_libtsan = 1721,                 /* -static-libtsan */
  OPT_static_libubsan = 1722,                /* -static-libubsan */
  OPT_static_pie = 1723,                     /* -static-pie */
  /* OPT_std_c__03 = 1724, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1725, */                /* -std=c++0x */
  OPT_std_c__11 = 1726,                      /* -std=c++11 */
  OPT_std_c__14 = 1727,                      /* -std=c++14 */
  OPT_std_c__17 = 1728,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1729, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1730, */                /* -std=c++1z */
  OPT_std_c__20 = 1731,                      /* -std=c++20 */
  OPT_std_c__23 = 1732,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1733, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1734, */                /* -std=c++2b */
  ...
  OPT_std_gnu__23 = 1759,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1760, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1761, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 1762,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1763,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1764,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1765, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1766, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1767,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1768, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1769,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1770,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1771, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1772, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1773,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1774, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1775, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1776, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1777, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1778, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1779,                     /* -std=legacy */
  OPT_symbol_ = 1780,                        /* -symbol= */
  OPT_symbolic = 1781,                       /* -symbolic */
  OPT_t = 1782,                              /* -t */
  OPT_time = 1783,                           /* -time */
  OPT_time_ = 1784,                          /* -time= */
  OPT_traditional = 1785,                    /* -traditional */
  OPT_traditional_cpp = 1786,                /* -traditional-cpp */
  OPT_tree_stats = 1787,                     /* -tree-stats */
  OPT_trigraphs = 1788,                      /* -trigraphs */
  OPT_type_stats = 1789,                     /* -type-stats */
  OPT_u = 1790,                              /* -u */
  OPT_undef = 1791,                          /* -undef */
  OPT_v = 1792,                              /* -v */
  OPT_version = 1793,                        /* -version */
  OPT_w = 1794,                              /* -w */
  OPT_wrapper = 1795,                        /* -wrapper */
  OPT_x = 1796,                              /* -x */
  OPT_z = 1797,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,

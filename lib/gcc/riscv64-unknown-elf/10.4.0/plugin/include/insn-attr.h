...
#define HAVE_ATTR_matrix_mcfgm_op_idx 1
extern int get_attr_matrix_mcfgm_op_idx (rtx_insn *);
#define HAVE_ATTR_matrix_mcfgn_op_idx 1
extern int get_attr_matrix_mcfgn_op_idx (rtx_insn *);
#define HAVE_ATTR_matrix_mcfgk_op_idx 1
extern int get_attr_matrix_mcfgk_op_idx (rtx_insn *);
#define HAVE_ATTR_matrix_ebytes 1
extern int get_attr_matrix_ebytes (rtx_insn *);
